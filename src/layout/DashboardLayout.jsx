...
import { HiLogout, HiOutlineChatAlt2, HiOutlineCog, HiOutlineDocumentText, HiOutlineHome, HiOutlinePlusCircle, HiOutlineUser, HiOutlineUserCircle, HiUser } from 'react-icons/hi';
                        ...
                        <ul tabIndex={0} className="dropdown-content menu bg-base-100 shadow-2xl rounded-box mt-3 w-52 p-2">
                            <li>
                                <a className="justify-between">
                                    <span className="font-semibold">{singUser?.name}</span>
                                    <span className="badge text-white bg-blue-500">User</span>
                                </a>
                            </li>
                            <li>
                                <a className="justify-between">
                                    <span className="font-semibold">{singUser?.email}</span>
                                </a>
                            </li>
            ...
            <div className="drawer-side is-drawer-close:overflow-visible">
                ...
                <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-50">
                    ...
                    <ul className="menu w-full grow">
                        ...
                        {/* our dashboard links */}
                        <li>
                            <Link className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Account Information" to="/dashboard">
                                <HiOutlineUserCircle className='w-5 h-5' />
                                <span className="is-drawer-close:hidden">Account Information</span>
                            </Link>
                        </li>
                        <li>
                            <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="My Issues" to="/dashboard/myIssues">
                                <HiOutlineDocumentText className="w-5 h-5" />
                                <span className="is-drawer-close:hidden">My Issues</span>
                            </NavLink>
                        </li>
                        <li>
                            <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Report Issue" to="/dashboard/reportIssue">
                                <HiOutlinePlusCircle className="w-5 h-5" />
                                <span className="is-drawer-close:hidden">Report Issue</span>
                            </NavLink>
                        </li>
                        <li>
                            <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="My Profile" to="/dashboard/profilePage">
                                <HiOutlineUser className="w-5 h-5" />
                                <span className="is-drawer-close:hidden">My Profile</span>
                            </NavLink>
                        </li>
                        <li>
                            <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Send Review" to="/dashboard/givenReview">
